...
// Written by:
// Onat Ribar           - createPT() && DIV macro
// Mahny Barazandehtar  - is_macro() && ADD macro
// Ayşegül Tekeli       - read()     && REM macro
// Ece Tipici           - parse()    && SUB macro
// Emir Devlet Ertörer  - expand()   && MULT macro
